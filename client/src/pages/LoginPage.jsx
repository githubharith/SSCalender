...
const LoginPage = () => {
  ...
  return (
    <GoogleOAuthProvider clientId="70995210409-osvu98nv8igogfk4n8t2rro16tcdnd0i.apps.googleusercontent.com">
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-gradient">Welcome to SSCalendar</h2>
            <p className="mt-2 text-sm text-gray-600">Smart Scheduling Calendar for seamless event management</p>
          </div>
          <div className="card">
                ...
                <div className="flex justify-center">
                  {isLoading ? (
                    ...
                    <GoogleLogin
                      ...
                      text="signin_with"
                      shape="rectangular"
                      redirect_uri="https://sscalender-frontend.onrender.com/auth/callback"
                    />
                  )}
                </div>
              </div>
